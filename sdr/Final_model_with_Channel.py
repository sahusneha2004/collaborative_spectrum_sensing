...
def main():
    ...
    # Matrix shape: [channels x metrics]
    # Metrics order: [Precision, Recall, F1]
    ...
    print("Rows   : Channels")
    print("Cols   : [Precision, Recall, F1-score]\n")
    ...
    ########################################
    # OPTIONAL: return matrix for saving
    ########################################
